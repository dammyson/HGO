...
<View style={{ flexDirection: 'row',  margin:30, marginTop:15 }}>
                        <Text style={{ color: '#fff',  fontSize: 14, fontFamily: 'NunitoSans-Bold', flex: 1 }}>TICKET {this.state.ticket_count_array[i]}</Text>
                    ...
                    <View style={{ marginLeft: 30, flex: 1 }}>
                        ...
                        <View style={styles.itemTwo}>
                            <TextInput
                                ...
                                autoCorrect={false}
                                style={styles.menu}
                                onChangeText={text =>  this.onChangeText(text, i, 'name')}
                            />
                        </View>
                    </View>
                </View>
                    ...
                    <View style={{ marginLeft: 30, flex: 1 }}>
                        ...
                        <View style={styles.itemTwo}>
                            <TextInput
                                ...
                                autoCorrect={false}
                                style={styles.menu}
                                onChangeText={text =>  this.onChangeText(text, i, 'qty')}
                            />
                        </View>
                    </View>
                </View>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={styles.item}>
                                    <TextInput
                                        ...
                                        autoCorrect={false}
                                        style={styles.menu}
                                        onChangeText={text =>  this.onChangeText(text, i, 'price')}
                                    />
                                </View>
                            </View>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={styles.item}>
                                    <TextInput
                                        ...
                                        autoCorrect={false}
                                        style={styles.menu}
                                        onChangeText={text =>  this.onChangeText(text, i, 'bprice')}
                                    />
                                </View>
                ...
                <View style={[styles.oneRow, { marginTop: 20 }]}>
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={styles.itemTwo}>
                            ...
                            <DatePicker
                                style={{ alignItems: 'flex-start', width: 300, color: '#101023', borderColor: '#101023', borderWidth: 3 }}
                                date={this.state.form_data.length > 0 + i  ? this.state.form_data[i].StartDate : this.state.startdate}
                                mode="datetime"
                                dateText
                                ...
                                onDateChange={(date) => { this.onChangeText(date, i, 'startdate') }}
                            />
                ...
                <View style={styles.oneRow}>
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={styles.itemTwo}>
                            <DatePicker
                                style={{ alignItems: 'flex-start', width: 300, color: '#101023', borderColor: '#101023', borderWidth: 3 }}
                                date={this.state.form_data.length > 0 + i  ? this.state.form_data[i].EndDate : this.state.enddate}
                                mode="datetime"
                                dateText
                                ...
                                onDateChange={(date) => { this.onChangeText(date, i, 'enddate') }}
                            />
                        </View>
                    </View>
                </View>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={styles.item}>
                                    <TextInput
                                        ...
                                        autoCorrect={false}
                                        style={styles.menu}
                                        onChangeText={text =>  this.onChangeText(text, i, 'min')}
                                    />
                                </View>
                            </View>
                            ...
                            <View style={{ flex: 1 }}>
                                ...
                                <View style={styles.item}>
                                    <TextInput
                                        ...
                                        autoCorrect={false}
                                        style={styles.menu}
                                        onChangeText={text =>  this.onChangeText(text, i, 'max')}
                                    />
                                </View>
                            </View>
